...
test('le formulaire de profil est utilisable au clavier seul', async ({ page }) => {
  ...
  // Chaque champ doit être atteignable en tabulant, dans l'ordre visuel.
  const order = ['Poids (kg)', 'Taille (cm)', 'Âge (années)', 'Table de référence utilisée', "Niveau d'activité physique"];
